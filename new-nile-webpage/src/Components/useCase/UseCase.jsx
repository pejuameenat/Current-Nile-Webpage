  ...
  return (
    <section className="py-6 lg:py-14 px-4 md:px-0 my-[72px]">
      <div className="container md:w-[85%] max-w-[1311px] mx-auto">
        ...
        <button type="button" className="bg-primary text-pry1 p-4 rounded-lg block mx-auto mt-6 hover:bg-black transitions" ><a href="https://app.nile.ng/" target="_blank" rel="noopener noreferrer">Get Started- its free</a> </button>
      </div>
    </section>
  );
};
