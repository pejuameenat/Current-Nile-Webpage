  ...
  return (
    ...
    <section  id="pricingSection" className="pb-5 lg:pb-[80px] px-4 lg:px-0">
      ...
      <span className="block text-center text-[#6e6e6e]">You can cancel anytime</span>
        ...
        <button type="button" className={monthlyPrice?"text-white w-full py-3 font-bold rounded-full bg-primary hover:text-[#6e6e6e] transitions" :'text-[#6e6e6e] w-32 py-3 font-bold rounded-full bg-[#fbfbfb] hover:text-[#6e6e6e] transitions'}onClick={()=>{dispatch(setMonthlyPrice(true))}}>Monthly</button>
